...
* The code is completely open-source. There are no private branches or hidden features. It is avaible on github at <https://github.com/hannorein/rebound>
...
* and many others! Check the git hisotry to find out who contributed to the code.
